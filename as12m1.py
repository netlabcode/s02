...
val1 = client.get_node("ns=2;i=452")
val2 = client.get_node("ns=2;i=453")
val3 = client.get_node("ns=2;i=454")
val4 = client.get_node("ns=2;i=455")
val5 = client.get_node("ns=2;i=456")
val6 = client.get_node("ns=2;i=457")
