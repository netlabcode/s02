...
val1 = client.get_node("ns=2;i=660")
val2 = client.get_node("ns=2;i=661")
val3 = client.get_node("ns=2;i=662")
val4 = client.get_node("ns=2;i=663")
val5 = client.get_node("ns=2;i=664")
val6 = client.get_node("ns=2;i=665")
