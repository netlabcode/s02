...
val1 = client.get_node("ns=2;i=458")
val2 = client.get_node("ns=2;i=459")
val3 = client.get_node("ns=2;i=460")
val4 = client.get_node("ns=2;i=461")
val5 = client.get_node("ns=2;i=462")
val6 = client.get_node("ns=2;i=463")
