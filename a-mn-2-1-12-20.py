...
def emptyNet():
    ...
    info( net[ 's01m1' ].cmd( 'python3.6 as01m1.py &amp' ) )
    info( net[ 's01m2' ].cmd( 'python3.6 as01m2.py &amp' ) )
    info( net[ 's01m3' ].cmd( 'python3.6 as01m3.py &amp' ) )
    info( net[ 's01m4' ].cmd( 'python3.6 as01m4.py &amp' ) )

    info( net[ 's02m1' ].cmd( 'python3.6 as02m1.py &amp' ) )
    info( net[ 's02m2' ].cmd( 'python3.6 as02m2.py &amp' ) )
    info( net[ 's02m3' ].cmd( 'python3.6 as02m3.py &amp' ) )
    info( net[ 's02m4' ].cmd( 'python3.6 as02m4.py &amp' ) )
    info( net[ 's02m5' ].cmd( 'python3.6 as02m5.py &amp' ) )
    info( net[ 's02m6' ].cmd( 'python3.6 as02m6.py &amp' ) )

    info( net[ 's12m1' ].cmd( 'python3.6 as12m1.py &amp' ) )
    info( net[ 's12m2' ].cmd( 'python3.6 as12m2.py &amp' ) )
    info( net[ 's12m3' ].cmd( 'python3.6 as12m3.py &amp' ) )

    info( net[ 's20m1' ].cmd( 'python3.6 as20m1.py &amp' ) )
