...
def serverOne():
	with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sc1:
		...
		while x < 6:
			...
			cursor.execute(" INSERT INTO s02m1(dtime, cb_ctrl, cb_res, i_res, p_res, q_res, v_res) VALUES (%s,%s,%s,%s,%s,%s,%s)", inserted_values)
...
def serverTwo():
	with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sc1:
		...
		while x < 6:
			...
			cursor.execute(" INSERT INTO s02m2(dtime, cb_ctrl, cb_res, i_res, p_res, q_res, v_res) VALUES (%s,%s,%s,%s,%s,%s,%s)", inserted_values)
...
def serverFour():
	with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sc1:
		...
		while x < 6:
			...
			cursor.execute(" INSERT INTO s02m4(dtime, cb_ctrl, cb_res, f_res, tr_tap, tr_tap_ctrl, ld_res, tr_tap_mode, , tr_tap_res , v_res) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", inserted_values)
...
def serverFive():
	with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sc1:
		...
		while x < 6:
			...
			cursor.execute(" INSERT INTO s02m5(dtime, cb_ctrl, cb_res) VALUES (%s,%s,%s)", inserted_values)
...
def serverSix():
	with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sc1:
		...
		while x < 6:
			...
			cursor.execute(" INSERT INTO s02m6(dtime, cb_ctrl, cb_res, f_res, ld_res, p_ctrl, p_res, q_res, v_ctrl, v_res) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", inserted_values)
