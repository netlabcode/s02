...
val1 = client.get_node("ns=2;i=464")
val2 = client.get_node("ns=2;i=465")
val3 = client.get_node("ns=2;i=466")
val4 = client.get_node("ns=2;i=467")
val5 = client.get_node("ns=2;i=468")
val6 = client.get_node("ns=2;i=469")
val7 = client.get_node("ns=2;i=470")
